...
<form action="{{ route('vehicles.store') }}" method="POST">
    ...
    <table>
        ...
        <tr>
            <td><input type="number" name="client_id" id="client_id" required hidden></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" id="client_document_number" name="client_document_number" required autocomplete="off">
                <div id="suggestions" style="border:1px solid #ccc;"></div>
            </td>
        </tr>
        <tr>
            <th>Nombres</th>
            <td><input type="text" id="client_first_name" name="client_first_name" readonly required></td>
        </tr>
        <tr>
            <th>Apellidos</th>
            <td><input type="text" id="client_last_name" name="client_last_name" readonly required></td>
        </tr>
        
        <tr>
            <th>Email</th>
            <td><input type="email" id="client_email" name="client_email" readonly required></td>
        </tr>
        <tr>
            <th>Telefono</th>
            <td><input type="text" id="client_phone_number" name="client_phone_number" readonly required></td>
        </tr>
    </table>
